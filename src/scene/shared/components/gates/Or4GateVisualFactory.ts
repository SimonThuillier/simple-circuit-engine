 ...
 */
export class Or4GateVisualFactory extends OrGateVisualFactory {
  ...
  override createVisual(component: Component): THREE.Object3D {
    ...
    envelopeMaterial.emissive.setHex(Or4GateVisualFactory.HIGH_COLOR);
    ...
    input1Group.position.set(0.54, 0, 1.45);
    ...
    input2Group.position.set(0.07, 0, 0.45);
    ...
    input3Group.position.set(0.07, 0, -0.7);
    ...
    input4Group.position.set(0.54, 0, -1.65);
    ...
    if (config.get('activationLogic') === 'negative') {
      ...
      if (!negativeMarkerMesh) {
        negativeMarkerMesh = new THREE.Mesh(
          Or4GateVisualFactory.negativeMarkerGeometry,
          Or4GateVisualFactory.negativeMarkerMaterial
        );
